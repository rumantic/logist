...
class Select extends Component
{
    ...
    public function mount($name,
                          ...
                          $selectView = 'livewire.components.ui.select.select',
                          $defaultView = 'livewire.components.ui.select.default',
                          $searchView = 'livewire.components.ui.select.search',
                          $searchInputView = 'livewire.components.ui.select.search-input',
                          $searchOptionsContainer = 'livewire.components.ui.select.search-options-container',
                          $searchOptionItem = 'livewire.components.ui.select.search-option-item',
                          $searchSelectedOptionView = 'livewire.components.ui.select.search-selected-option',
                          $searchNoResultsView = 'livewire.components.ui.select.search-no-results',
                          $extras = [])
    {
        $this->name = $name;
